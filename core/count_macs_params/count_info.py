...
from .flops_of_ops import count_parameters, register_hooks
...
def profile(
    ...
    def add_hooks(m: nn.Module):
        ...
        if m_type in _custom_ops:
            ...
            if m_type not in types_collection and verbose_for_hook:
                tools.prRed(f"[WARN] Cannot find rule for {m_type}. Treat it as zero Macs and zero Params.")
    ...
    def dfs_count(module: nn.Module, prefix="->") -> (int, int):
        ...
        layer_infos.append((prefix, f"LayerSelf: ops: {_total_ops}, params: {_total_params}"))
        ...
        layer_infos.append((prefix, f"LayerTotal: ops: {_total_ops}, params: {_total_params}"))
